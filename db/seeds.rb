Board.create(name: "Food & Drink")
Board.create(name: "Feelings & Actions")
Board.create(name: "Things & Stuff")
...
categorized_word_list.each do |content|
  ...
  unless img
    img = Image.create(label: label, private: false, category: category, ai_generated: CREATE_AI_IMAGES)
...
first_board.images << Image.find_by(label: "hamburger")
first_board.images << Image.find_by(label: "sandwich")
first_board.images << Image.find_by(label: "apple")
first_board.images << Image.find_by(label: "cookie")
first_board.images << Image.find_by(label: "chicken")
first_board.images << Image.find_by(label: "crackers")
first_board.images << Image.find_by(label: "chocolate")
first_board.images << Image.find_by(label: "milk")
first_board.images << Image.find_by(label: "water")
first_board.images << Image.find_by(label: "food")
first_board.images << Image.find_by(label: "sweet")

second_board = Board.second
second_board.images << Image.find_by(label: "to sleep")
second_board.images << Image.find_by(label: "to talk")
second_board.images << Image.find_by(label: "more")
second_board.images << Image.find_by(label: "please")
second_board.images << Image.find_by(label: "bake")
second_board.images << Image.find_by(label: "is")
second_board.images << Image.find_by(label: "yum")
second_board.images << Image.find_by(label: "eat")
second_board.images << Image.find_by(label: "want")
second_board.images << Image.find_by(label: "good")
second_board.images << Image.find_by(label: "bite")

third_board = Board.third
third_board.images << Image.find_by(label: "my book")
third_board.images << Image.find_by(label: "toilet")
third_board.images << Image.find_by(label: "a friend")
third_board.images << Image.find_by(label: "medicine")

puts "Seeding complete!"
puts "Created #{Board.count} boards."
puts "Created #{Image.count} images."
puts "Created #{BoardImage.count} board_images."
